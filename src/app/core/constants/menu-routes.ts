...
export const MENU_ROUTE_BY_CODE: Record<string, string> = {
  ...
  [MenuCodes.ClassTimetable]: '/timetable/grid',
  [MenuCodes.MyTimetable]: '/timetable/my',
  ...
  [MenuCodes.LeaveTypes]: '/leave/types',
  [MenuCodes.LeavePolicies]: '/leave/policies',
  [MenuCodes.LeaveBalances]: '/leave/balances',
  ...
  [MenuCodes.ExamGroups]: '/exams/groups',
  [MenuCodes.Exams]: '/exams/list',
  [MenuCodes.ExamSchedule]: '/exams/schedule',
  [MenuCodes.ExamMarksEntry]: '/exams/marks-entry',
  [MenuCodes.ExamResults]: '/exams/results',
