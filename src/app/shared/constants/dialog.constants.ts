...
/** Soft cap — dialog sizes to content; CSS prevents forced scroll. */
export const FEE_DIALOG_MAX_HEIGHT = '92vh';

/** Role → assign users popup (multi-select + staged table). */
export const ROLE_ASSIGN_USERS_DIALOG_WIDTH = '920px';
